...
namespace VNguesserStructure
{
    ...
    public sealed partial class GameLobbyPage : Page
    {
        ...
        //From Game Lobby back to Home Page
        private void GotoHomePageButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(HomePage));
        }

        //From Game Lobby to In Game Page
        private void GotoInGamePageButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(InGamePage));
        }
